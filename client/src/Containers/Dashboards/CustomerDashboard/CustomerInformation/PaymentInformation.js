...
const PaymentInformation = () => {
  ...
  return (
    <Card sx={{ maxWidth: '50%', border: "2px solid #900C3D", boxShadow: '1px 0px 8px 1px #F60F56' }} >
      <CardHeader sx={{ border: "1px solid #900C3D" }} avatar={<Avatar aria-label="recipe">R</Avatar>} title="Payment Information" action={ <IconButton aria-label="settings" color="primary"><Settings fontSize="large" /></IconButton> } />
      <CardContent >
